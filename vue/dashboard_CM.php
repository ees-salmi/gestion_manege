...
<body>
    ...
    $CM_query = "SELECT prenom_personnel, nom_personnel, date_naissance FROM personnel WHERE nom_personnel = '$username'";
    $CM_result = mysqli_query($db, $CM_query);
    $CM_row = mysqli_fetch_assoc($CM_result);
    $prenom = $CM_row['prenom_personnel'];
    $nom_famille = $CM_row['nom_personnel'];
    $date_naissance = $CM_row['date_naissance'];
