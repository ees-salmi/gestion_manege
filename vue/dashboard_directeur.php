...
<body>
  ...
  // recuperer le role du personnel
  ...
  // selectionner les information du directeur depuis la base de données
  ...
  <div class="container">
    ...
    <div id="result-container">
      ...
      <a href="../vue/gerer_manege.php">gestion des manegre</a>
    </div>
    <!-- affichage des information du directeur-->
    <div class="content">
      <div class="card">
