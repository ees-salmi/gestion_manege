...
<body>
    ...
    $Serveur_query = "SELECT prenom_personnel, nom_personnel, date_naissance FROM personnel WHERE nom_personnel = '$username'";
    $Serveur_result = mysqli_query($db, $Serveur_query);
    $Serveur_row = mysqli_fetch_assoc($Serveur_result);
    $prenom = $Serveur_row['prenom_personnel'];
    $nom_famille = $Serveur_row['nom_personnel'];
    $date_naissance = $Serveur_row['date_naissance'];

    mysqli_close($db);
    ?>
    <div class="container">
        <div class="header">
            <h1>Dashboard Serveur</h1>
