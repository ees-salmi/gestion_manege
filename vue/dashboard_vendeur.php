...
<body>
    ...
    $Vendeur_query = "SELECT prenom_personnel, nom_personnel, date_naissance FROM personnel WHERE nom_personnel = '$username'";
    $Vendeur_result = mysqli_query($db, $Vendeur_query);
    $Vendeur_row = mysqli_fetch_assoc($Vendeur_result);
    $prenom = $Vendeur_row['prenom_personnel'];
    $nom_famille = $Vendeur_row['nom_personnel'];
    $date_naissance = $Vendeur_row['date_naissance'];
...
git branch -M main
git remote add origin https://github.com/Oussamaaitelhadj/parc.git
